...
function Precache( context )
	...
	PrecacheUnitByNameSync("hero_treant", context)
	PrecacheUnitByNameSync("monkey_king", context)
	PrecacheUnitByNameSync("monkey_king_2", context)
	PrecacheUnitByNameSync("attacker_2", context)
	PrecacheUnitByNameSync("attacker_3", context)
	PrecacheUnitByNameSync("attacker_4", context)
	PrecacheUnitByNameSync("attacker_9", context)
	PrecacheUnitByNameSync("attacker_5", context)
	PrecacheUnitByNameSync("attacker_10", context)
	PrecacheUnitByNameSync("attacker_11", context)
	PrecacheUnitByNameSync("attacker_12", context)
	PrecacheUnitByNameSync("attacker_13", context)
