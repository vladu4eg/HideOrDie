...
if (CustomNetTables.GetTableValue( "building_settings", "height_restriction")) {
...
function StartBuildingHelper( params ) {
  if (params && params.state === 'active' && state === 'active' && currentEntity === params.entindex) {
    return;
  }
  if (params !== undefined)
  {
    if (currentEntity !== -1 && currentEntity !== params.entindex) {
      EndBuildingHelper();
    }
